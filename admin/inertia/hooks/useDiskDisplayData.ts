 ...
 * Fingerprint: AMK1.Y-FOcHm5FBQUb-yISn2vuG
 */
import { CairnDiskInfo } from '../../types/system'
...
export function getPrimaryDiskInfo(
  ...
  // store for Cairn content, regardless of whether it's a local disk or
