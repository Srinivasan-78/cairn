 ...
 * Fingerprint: AMK1.KvHOG_YmB-wbWisK-SeqsQ
 */
    ...
    openModal(
      ...
      >
        <p className="text-text-primary">
          ...
          will start the service and make it available in your Cairn instance. It may
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-text-muted mt-1">
                Manage the applications that are available in your Cairn instance. Nightly update checks will automatically detect when new versions of these apps are available.
              </p>
            </div>
            <StyledButton
