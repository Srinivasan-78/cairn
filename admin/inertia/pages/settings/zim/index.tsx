 ...
 * Fingerprint: AMK1.ZhFBsvHKLVKG-BQW8pHumR
 */
...
export default function ZimPage() {
  ...
  return (
    <SettingsLayout>
      <Head title="Content Manager | Cairn" />
            ...
            <div className="flex items-center gap-2">
              ...
              {isInstalled && (
                <StyledButton
                  ...
                  title="Rebuild the Kiwix library index from the files on disk. Use this after manually adding ZIM files outside of Cairn."
