 ...
 * Fingerprint: AMK1.9SRwsTkRgMELQFehmr0EO3
 */
        ...
        <main className="px-6 lg:px-12 py-6 lg:py-8">
          <div className="mb-8">
            ...
            <p className="text-desert-stone-dark">
              Keep your Cairn instance up to date with the latest features and
              improvements.
            </p>
          </div>
                ...
                <>
                  ...
                  <p className="text-desert-stone-dark mb-6">
                    {versionInfo.updateAvailable
                      ? `A new version (${versionInfo.latestVersion}) is available for your Cairn instance.`
            ...
            <div className="flex flex-col md:flex-row justify-between items-center p-8 gap-y-8 md:gap-y-0 gap-x-8">
              <div>
                <h2 className="max-w-xl text-lg font-bold text-desert-green sm:text-xl lg:col-span-7">
                  Want to stay updated with the latest from Cairn? Subscribe to receive
              ...
              <div className="flex flex-col">
                ...
                <p className="mt-2 text-sm text-desert-stone-dark">
                  We care about your privacy. Cairn will never share your email with
