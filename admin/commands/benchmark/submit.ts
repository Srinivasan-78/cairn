 ...
 * Fingerprint: AMK1.slvegi-K1x0FpKSiPhtfyj
 */
...
export default class BenchmarkSubmit extends BaseCommand {
  ...
  async run() {
    ...
    try {
      ...
      this.logger.info(`  Cairn Score: ${result.cairn_score.toFixed(2)}`)
      this.logger.info('')
      ...
      this.logger.info('')
      this.logger.info('Thank you for contributing to the Cairn community!')
