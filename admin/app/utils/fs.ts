...
export function getAllFilesystems(
  ...
  fsSize: CairnDiskInfoRaw['fsSize']
): CairnDiskInfoRaw['fsSize'] {
  const filesystems: CairnDiskInfoRaw['fsSize'] = []
  const seen = new Set()
